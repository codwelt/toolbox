...
use App\Http\Controllers\Web\OrthographyCheckerController;
...
use App\Http\Controllers\Api\OrthographyCheckerApiController;
...
Route::get('/corrector-ortografico-web', [OrthographyCheckerController::class, 'index'])->name('tools.orthography-checker');
...
Route::post('/api/tools/orthography-checker', [OrthographyCheckerApiController::class, 'check'])->name('api.tools.orthography-checker');
