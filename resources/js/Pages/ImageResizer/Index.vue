...
const pageTitle = computed(() => seoData.value.title || 'Redimensionar imágenes online gratis');
const pageDescription = computed(
    () =>
        seoData.value.description ||
        'Ajusta ancho y alto de tus imágenes manteniendo la calidad, listo para web o redes sociales.'
);
...
const jsonLd = computed(() => {
    const faqStructured = faqItems.value.map((item) => ({
        '@type': 'Question',
        name: item.question,
        acceptedAnswer: {
            '@type': 'Answer',
        ...
        <section class="py-5 bg-dark text-white">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-10">
                        <p class="text-uppercase small mb-2 text-info fw-semibold">Redimensionar</p>
                        <h1 class="display-5 fw-bold mb-3">{{ seoData.h1 }}</h1>
                        <p class="lead text-white-50 mb-3">
                            {{ pageDescription }}
                        </p>
                        <div class="d-flex flex-wrap gap-2">
                            <span class="badge bg-info text-dark">Mantén proporción</span>
                            <span class="badge bg-info text-dark">Preajustes redes</span>
